...
import { Img, Text, CheckBox, Heading } from "../../components";
...
const clothingGrid = [
  { jacketImage: "images/img_sweater_gray_800.svg", jacketTitle: "Jacket", collectionDescription: "Collection" },
  { jacketImage: "images/img_tshirt.svg", jacketTitle: "Shirt", collectionDescription: "Collection" },
  { jacketImage: "images/img_pants.svg", jacketTitle: "Pants", collectionDescription: "Collection" },
  { jacketImage: "images/img_skirt_gray_800.svg", jacketTitle: "Skirt", collectionDescription: "Collection" },
  { jacketImage: "images/img_sweater_gray_800.svg", jacketTitle: "Jacket", collectionDescription: "Collection" },
  { jacketImage: "images/img_sweater_gray_800.svg", jacketTitle: "Jacket", collectionDescription: "Collection" },
  { jacketImage: "images/img_sweater_gray_800.svg", jacketTitle: "Jacket", collectionDescription: "Collection" },
  { jacketImage: "images/img_sweater_gray_800.svg", jacketTitle: "Jacket", collectionDescription: "Collection" },
...
export default function CategorieswithSidebarPage() {
  return (
    <>
      <Helmet>
        <title>Shop by Category with Sidebar - Elliye</title>
        <meta
          name="description"
          content="Explore our collections and filter by price, rating, or brand. Find jackets, shirts, pants, and more. Shop the latest trends in fashion with Elliye."
        />
      </Helmet>
                ...
                <div className="flex w-[14%] flex-col gap-8 md:w-full">
                  <div className="flex flex-col gap-7">
                    <div className="flex items-center justify-between gap-5">
                      ...
                      <Img src="images/img_arrow_down.svg" alt="Price Dropdown" className="h-[24px] w-[24px]" />
                    </div>
                  ...
                  <div className="flex flex-col gap-7">
                    <div className="flex items-center justify-between gap-5">
                      ...
                      <Img src="images/img_arrow_down.svg" alt="Rating Dropdown" className="h-[24px] w-[24px]" />
                    </div>
                    <div className="flex flex-col gap-4">
                      <div className="flex gap-4">
                        <div className="h-[24px] w-[24px] border-[3px] border-solid border-blue_gray-100" />
                        <Img src="images/img_star_1.svg" alt="One Star Image" className="h-[24px] w-[24px]" />
                      </div>
                      <div className="flex">
                        <div className="h-[24px] w-[24px] border-[3px] border-solid border-blue_gray-100" />
                        <div className="flex flex-1 gap-2 px-4">
                          <Img src="images/img_star_1_24x24.svg" alt="First Star Image" className="h-[24px] w-[24px]" />
                          <Img src="images/img_star_2.svg" alt="Second Star Image" className="h-[24px] w-[24px]" />
                        </div>
                      </div>
                      <div className="flex">
                        <div className="h-[24px] w-[24px] border-[3px] border-solid border-blue_gray-100" />
                        <div className="flex flex-1 gap-2 px-4">
                          <Img src="images/img_star_1_1.svg" alt="First Star Image" className="h-[24px] w-[24px]" />
                          <Img
                            src="images/img_star_2_24x24.svg"
                            alt="Second Star Image"
                            className="h-[24px] w-[24px]"
                          />
                          <Img src="images/img_star_3.svg" alt="Third Star Image" className="h-[24px] w-[24px]" />
                        </div>
                      </div>
                  ...
                  <div className="flex items-center justify-between gap-5">
                    ...
                    <Img src="images/img_arrow_down.svg" alt="Brand Dropdown" className="h-[24px] w-[24px]" />
                  </div>
                  <div className="flex items-center justify-between gap-5">
                    <Text as="p" className="text-[18px] font-medium text-gray-800 lg:text-[15px]">
                      Filter by Size
                    </Text>
                    <Img src="images/img_arrow_down.svg" alt="Size Dropdown" className="h-[24px] w-[24px]" />
                  </div>
                </div>
