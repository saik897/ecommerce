...
const tableData = [
  ...
  {
    placeholderImage: "images/img_warm_pants_pxl7hrp.png",
        ...
        cell: (info) => (
          <div className="flex flex-1 items-center gap-[66px] sm:flex-col">
            <div className="w-[34%] border border-solid border-blue_gray-100 p-2.5 sm:w-full">
              <Img
                src={info.row.original.placeholderImage}
          ...
          <div>
            ...
            <div className="relative mt-[-48px] flex justify-between gap-5">
              ...
              <div className="flex flex-col items-center bg-gray-800 p-4">
                <Img src={info.getValue()} alt="Increase View" className="h-[16px] w-[16px]" />
              </div>
            </div>
          </div>
        ),
      ...
      <div className="mt-[30px] flex flex-col items-center">
        <div className="container-xs flex flex-col items-center lg:px-5 md:px-5">
          ...
          <div className="mt-24 flex flex-col gap-[78px] self-stretch lg:gap-[78px] md:gap-[58px] sm:gap-[39px]">
            ...
            <div className="flex flex-col gap-[78px] lg:gap-[78px] md:gap-[58px] sm:gap-[39px]">
                ...
                <div className="flex items-start md:flex-col">
                  <div className="flex w-[28%] items-center justify-between gap-5 border border-solid border-blue_gray-100 md:w-full">
                    <Text
                      size="texts"
                      as="p"
                      className="mb-3.5 ml-4 self-end text-[18px] font-normal tracking-[0.36px] text-gray-500_7f lg:text-[15px]"
                    >
                      Enter coupon code
                    </Text>
